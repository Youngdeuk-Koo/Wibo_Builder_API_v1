...
class Statement():
    ...
    def set_result(self, module, intent, confidence, chatbot_id, logic_property):
        self.result['module'].append(str(module))
        self.result['intent'].append(str(intent))
    
        self.result['confidence'] = round(confidence, 1)

        self.result['chatbot_id'] = chatbot_id
        self.result['logic_property'] = str(logic_property)
    ...
    # def set_confidence_list(self, confidence):
